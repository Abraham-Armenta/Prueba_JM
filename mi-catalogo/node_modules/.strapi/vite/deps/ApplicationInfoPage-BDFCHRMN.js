...
var ApplicationInfoPage = () => {
  ...
  const AdminSeatInfo = useEnterprise(AdminSeatInfoCE, async () => (await import("./AdminSeatInfo-5Y2LRCIG.js")).AdminSeatInfoEE);
  const isAiEnabled = ((_a = window.strapi.ai) == null ? void 0 : _a.enabled) !== false;
  const AIUsageData = useEnterprise(AIUageDataCE, async () => (await import("./AIUsage-QQJBGUUJ.js")).AIUsage, {
    enabled: isAiEnabled
  });
...
//# sourceMappingURL=ApplicationInfoPage-BDFCHRMN.js.map
